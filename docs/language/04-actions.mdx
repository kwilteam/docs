...
Access modifiers specify when an action can be called. There are 3 primary access modifiers, and 2 optional access modifiers.
Each action must have exactly one primary access modifier, and can have zero or more optional access modifiers.
