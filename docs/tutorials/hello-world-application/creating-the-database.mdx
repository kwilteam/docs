...
Before you begin, ensure that you have the prerequisites outlined in ["Prerequisites"](../../prerequisites.md). The Kwil testnet tokens received from the [faucet](https://faucet.kwil.com) will be used to fund the database.
