...
> **TODO** NB - add alt / title / hover text over all icons in the Kuneiform IDE, e.g. Connect Wallet, LHS Nav bar, the new file and new folder icons etc.
...
> **TODO, no, use either Goerli or existing public Kwil test network**
...
> **TODO** add a red arrow highlighting the 'New Workspace' option.
...
> **TODO** Believe that https://provider.kwil.com would make sense for a 1st pass Tutorial example as it does NOT require the user to set up their own network as a prerequisite.

> **TODO** How can I delete or Edit a Workspace once I've added it in the Kuneiform IDE?
...
Then, click `Compile`. Your Kuneiform code will now be checked for errors, and compiled **TODO** into EVM bytecode??
