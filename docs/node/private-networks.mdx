...
The whitelist can also be updated dynamically using the `kwil-admin whitelist` commands. Refer to the [Kwil Admin Peers Subcommand](/docs/ref/kwild/peers) documentation for more information.
