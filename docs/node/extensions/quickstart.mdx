...
Kwil currently supports libraries for building extensions in both [TypeScript/JavaScript](/docs/extensions/packages/js-ts) and [Golang](/docs/extensions/packages/go).
...
To build an extension server in TypeScript/JavaScript, we will be referencing the example found [here](/docs/extensions/packages/js-ts).
...
2. Paste the example code from the [JavaScript Extension Example](/docs/extensions/packages/js-ts#example-of-building-an-extenstion) into the file, or write your own extension.
...
To build an extension server in Golang, we will be referencing the example found [here](/docs/extensions/packages/go)
...
2. Paste the example code from the [Golang Extension Example](/docs/extensions/packages/go#example-of-building-an-extension) into the file, or write your own extension.
...
To get started using the extension within Kuneiform, check out the [Kuneiform Guide for extensions](/docs/extensions/kuneiform).  Or, if you're curious to learn how to build more
complex extensions, check out the guide to the structure of extensions [here](/docs/extensions/implementation).
