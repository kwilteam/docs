...
Before you start, make sure you follow the [kwil-db clone](/docs/extensions/quickstart#prerequisites) instructions and have all the necessary tools installed.

Additionally, you will need:

- [Node.js](https://nodejs.org/en/download/) - v18 or higher

## Step 1: Make ed25519 directory

In your cloned `kwil-db` repository, create a new directory called `extensions/ed25519_demo`.

```bash
mkdir extensions/ed25519_demo
```

## Step 2: Create the extension

In the `extensions/ed25519_demo` directory, create a new file called `ed25519_example.go` and add the following code.
...
import (
    ...
    "github.com/YOUR_ORG_NAME/kwil-db/extensions/auth"
)
...
## Step 4: Use the extension in client app
