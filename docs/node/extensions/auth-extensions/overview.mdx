...
Authentication extensions use the `extensions/auth` package in kwil-db.

## Authentication Extension Overview
...
<details>
<summary>RegisterAuthenticator API Reference</summary>
...
`auth.Authenticator` is an interface from the `kwil-db/core` directory that is used to verify signatures and get the identifier of a message sender. It is passed to the [`RegisterAuthenticator`](#registerauthenticator) function.

The `auth.Authenticator` interface has two methods: `Verifier` and `Identifier`.

<details>
<summary>auth.Authenticator API Reference</summary>
...
<details>
<summary>Verifier API Reference</summary>
...
<details>
<summary>Identifier API Reference</summary>
