...
id: resolutions-ext-example
title: Resolution Credit Example
description: A resolution that can be used to credit user accounts.
slug: /extensions/resolutions/example
---

In this example, we will create a resolution that can credit accounts with the networks native gas token. This example is based off of the
...
is already available in the Kwil network. It can be found [here](<https://github.com/kwilteam/kwil-db/blob/main/extensions/resolutions/credit/credit.go>).
...
To use the resolution, please see the [oracles example](/docs/extensions/oracles/example) for an oracle capable of reading EVM event logs
