...
as how to register custom resolutions, see the Resolution Extensions section. TODO: link to resolution extensions once it exists.
...
More information on how to set local node configurations can be found [here](<google.com>) TODO: add link.
