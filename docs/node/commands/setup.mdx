...
1. When you already have a node private key and config file and want to create a genesis file for a new network. This scenario is described in the [Production Guide](/docs/node/production-guide#creating-a-genesis-file).
