...
Like the persistent peers setting, this is a comma-separated list of nodes using the same notation. Unlike persistent peers, the connections to these nodes are transient, disconnecting after obtaining a list of their peers.
