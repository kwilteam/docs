...
kwil-admin setup peer --root-dir ./testnet/node1 --genesis ./testnet/node0/genesis.json \
  ...
  --app.jsonrpc-listen-addr=localhost:8485 --app.http-listen-addr=localhost:8081 \
  --app.admin-listen-addr=/tmp/node1.sock --chain.rpc.listen-addr=tcp://127.0.0.1:26658 \
