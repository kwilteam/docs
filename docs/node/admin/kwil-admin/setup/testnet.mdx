...
```
  ...
  -p, --p2p-port int                   p2p port for nodes (default 26656)
      --snapshots.enable               enables db snapshots
      --snapshots.heights uint         Heights to snapshot the db (default 10000)
      --snapshots.max-snapshots uint   Maximum number of snapshots to store in the device (default 3)
