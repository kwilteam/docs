...
`credit_account` resolution found in the [default Kwil implementation](https://github.com/kwilteam/kwil-db/blob/main/extensions/resolutions/credit/credit.go). It is purely for example purposes, since the default implementation
