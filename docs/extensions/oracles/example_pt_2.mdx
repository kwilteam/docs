...
subscription disconnections, Ethereum reorgs, and other edge cases. For a production-ready implementation of this event listener, please refer to the [Kwil EVM Deposits Listener](<https://github.com/kwilteam/kwil-db/tree/main/extensions/listeners/eth_deposits>) that is
