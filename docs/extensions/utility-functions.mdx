...
transfer tokens, update validator power, and more. These are accessed in the [`github.com/kwilteam/kwil-db/common/functions`](https://pkg.go.dev/github.com/kwilteam/kwil-db/common/functions) package. For example, to credit
