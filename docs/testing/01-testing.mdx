...
features. They use the Go testing SDK, and therefore the tests themselves mus be written in Go.
...
To get started, see the files for either the [`kwil-cli` tests](/docs/testing/kwil-cli) or the
[Go SDK tests](/docs/testing/go-sdk).