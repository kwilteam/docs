...
To deploy the database, we will use the [Kwil CLI](/docs/category/cli).  To deploy the database, run the following command:

```bash
# highlight-next-line
$ kwil-cli database deploy --path=./path/to/social_media.kf --kwil-provider='https://provider.kwil.com' --private-key=5331ae5e0fd371797e4fa9ee029f99cb8ebab069e8ce5d33829882d79fc7d345
...
```bash
# highlight-next-line
$ kwil-cli utils query-tx a84f6775888bcd516cb93cc5c6e15f497143df87089151404e2653925388afba --kwil-provider='https://provider.kwil.com'
