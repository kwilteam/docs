...
```bash
# highlight-next-line
$ kwil-cli database deploy --path=./path/to/social_media.kf --kwil-provider='https://testnet.kwil.com' --chain-id 'kwil-chain-testnet-0.6' --private-key 'your-private-key' --sync
