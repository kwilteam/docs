...
Out of the box, Kwil supports a variety of access control capabilities. If you wish to implement more advanced access control logic than what is natively available, you can do so by adding an [Extension](/docs/extensions/precompiles) to your network.

## Raising Errors

In a procedure, you can raise errors that will cancel execution. Below, we query our [users table](/docs/getting-started/create-a-database#defining-tables) to ensure
