...
| ---- | ------------ | --- | -------- |
| Kwil Longhorn Testnet (v0.7) | Kwil JS/TS [SDK](/docs/sdks/js-ts/overview) <br/> Kwil [CLI](/docs/category/cli) | https://longhorn.kwil.com | `longhorn` |
| Kwil v0.6 Testnet | Kwil JS/TS [SDK](/docs/sdks/js-ts/overview) <br/> Kwil [CLI](/docs/category/cli) | https://testnet.kwil.com | `kwil-chain-testnet-0.6` |
