...
Note that this SDK must be used with a Kwil Node v0.6.0 and above. If you are not using a Kwil Node on v0.6.0 or above, please use [Kwil v3](https://www.npmjs.com/package/kwil).
...
Out of the box, Kwil supports Secp256k1 (Etherum) and Ed25519 signatures. Their corresponding identifiers are below:
