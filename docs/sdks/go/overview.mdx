...
The Go Client documentation and tutorial is available in the [`kwil-db` GitHub repository](https://github.com/kwilteam/kwil-db). The repository also contains an example to help you get started with the Go Client.
