...
Check the step-by-step guide [deploy contracts](https://github.com/kwilteam/rewards_contracts/blob/main/docs/tasks.md#deploy) to deploy the Escrow Contract.

To run the Relayer service, check [run relayer](https://github.com/kwilteam/rewards_contracts/blob/main/docs/poster.md) for instructions.
